import{r as a,j as e}from"./iframe-BRyn7lfK.js";import{c as u,R as i}from"./emotion-styled-base.browser.esm-_fFkGExi.js";import{i as s}from"./thumbnail-Bx3by73L.js";import{S as m}from"./index-DyH8tnRN.js";import"./preload-helper-Dp1pzeXC.js";import"./index-CyWFbepN.js";const f=u("div",{target:"e1toyhrq1"})({name:"1878o4o",styles:"display:grid;gap:20px"}),d=u("img",{target:"e1toyhrq0"})({name:"1u8hqvf",styles:"border-radius:4px"}),E={component:i,title:"Transitions/Slide",argTypes:{in:{type:{name:"boolean",required:!0},description:"If `true`, the component will transition in."},appear:{description:"By default the child component does not perform the enter transition when it first mounts, regardless of the value of in. If you want this behavior, set both appear and in to true. ",defaultValue:{summary:!1}},direction:{description:"Direction the child node will enter from.",options:["left","right","up","down"],control:{type:"radio"}},container:{description:`An HTML element, or a function that returns one.
